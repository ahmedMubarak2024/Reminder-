        ...
        binding.saveReminder.setOnClickListener {
            ...
            if (_viewModel.validateEnteredData(reminderDataItem)) {
                if ((activity as RemindersActivity).foregroundAndBackgroundLocationPermissionApproved()) {
                    (activity as RemindersActivity).checkDeviceLocationSettings(
                        success = {
                            (activity as RemindersActivity).addGeofenceForClue(reminderDataItem)
                ...
                } else (activity as RemindersActivity).requestForegroundAndBackgroundLocationPermissions()
            }
